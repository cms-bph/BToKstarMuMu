...
def proc_one_job(rootfile, datatype, label, job=None, test=False, 
    ...
    elif label in [ 'Run2011B-PromptReco-v1_run2011v0.2' 
                   ]:
        procdir = os.path.join(atr.afbpath,
        'rel/CMSSW_4_2_8_patch7/src/BphAna/BToKstarMuMu_run2011v0/python')
        cmd = 'cmsRun btokstarmumu_Run2011A-PromptReco_v2.py'
 
    elif label in [ 'Run2011B-PromptReco-v1_run2011v0.3' 
                   ]:
        procdir = os.path.join(atr.afbpath,
        'rel/CMSSW_4_2_8_patch7/src/BphAna/BToKstarMuMu_run2011v0/python')
        cmd = 'cmsRun btokstarmumu_Run2011A-PromptReco_v3.py'
    
    elif label in [ 'Run2011B-PromptReco-v1_run2011v0.4' 
                   ]:
        procdir = os.path.join(atr.afbpath,
        'rel/CMSSW_4_2_8_patch7/src/BphAna/BToKstarMuMu_run2011v0/python')
        cmd = 'cmsRun btokstarmumu_Run2011A-PromptReco_v4.py'
