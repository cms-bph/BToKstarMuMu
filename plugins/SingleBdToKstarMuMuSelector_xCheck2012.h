...
#ifndef SingleBdToKstarMuMuSelector_xCheck2012_h
#define SingleBdToKstarMuMuSelector_xCheck2012_h
...
class SingleBdToKstarMuMuSelector_xCheck2012 : public TSelector {
public :
   ...
   Double_t        evWeight;
   Double_t        evWeightE2;
   UInt_t          numEventsTried;  //2012
   UInt_t          numEventsPassed; //2012
   ...
   vector<double>  *mumDeltaRwithMC; // 2012
   ...
   //vector<bool>    *mum2LastTrigFilter; //2011
   ...
   vector<double>  *mupDeltaRwithMC; // 2012
   ...
   //vector<bool>    *mup2LastTrigFilter; // 2011
   ...
   vector<double>  *kstTrkmDeltaRwithMC; // 2012
   ...
   vector<double>  *kstTrkpDeltaRwithMC; // 2012
   ...
   Double_t        genPsiVtxY;
   Double_t        genPsiVtxZ;
   Int_t           genMumMother; // 2012
   Double_t        genMumPx;
   Double_t        genMumPy;
   Double_t        genMumPz;
   //Bool_t          trueMumTriggered; // 2011
   //Bool_t          trueMumInAcceptance; // 2011
   Int_t           genMupMother; // 2012
   Double_t        genMupPx;
   Double_t        genMupPy;
   Double_t        genMupPz;
   //Bool_t          trueMupTriggered; // 2011
   //Bool_t          trueMupInAcceptance; // 2011
   Int_t           genKstTrkmMother; // 2012
   Double_t        genKstTrkmPx;
   Double_t        genKstTrkmPy;
   Double_t        genKstTrkmPz;
   Int_t           genKstTrkpMother; // 2012
   ...
   TBranch        *b_numEventsTried;   //!
   TBranch        *b_numEventsPassed;   //!
   TBranch        *b_TrigTable;   //!
   ...
   TBranch        *b_rightFlavorTag;   //!
   TBranch        *b_TrigCat;   //!
   TBranch        *b_CosThetaKArb;   //!
   TBranch        *b_CosThetaMuArb;   //!
   TBranch        *b_PhiKstMuMuPlaneArb;   //!

   SingleBdToKstarMuMuSelector_xCheck2012(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SingleBdToKstarMuMuSelector_xCheck2012() { }
...
#ifdef SingleBdToKstarMuMuSelector_xCheck2012_cxx
void SingleBdToKstarMuMuSelector_xCheck2012::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("numEventsTried", &numEventsTried, &b_numEventsTried);
   fChain->SetBranchAddress("numEventsPassed", &numEventsPassed, &b_numEventsPassed);
   ...
   fChain->SetBranchAddress("mumDeltaRwithMC", &mumDeltaRwithMC, &b_mumDeltaRwithMC);
   ...
   fChain->SetBranchAddress("mupDeltaRwithMC", &mupDeltaRwithMC, &b_mupDeltaRwithMC);
   ...
   fChain->SetBranchAddress("kstTrkmDeltaRwithMC", &kstTrkmDeltaRwithMC, &b_kstTrkmDeltaRwithMC);
   ...
   fChain->SetBranchAddress("kstTrkpDeltaRwithMC", &kstTrkpDeltaRwithMC, &b_kstTrkpDeltaRwithMC);
   ...
   fChain->SetBranchAddress("genMumMother", &genMumMother, &b_genMumMother);
   ...
   fChain->SetBranchAddress("genMupMother", &genMupMother, &b_genMupMother);
   ...
   fChain->SetBranchAddress("genKstTrkmMother", &genKstTrkmMother, &b_genKstTrkmMother);
   ...
   fChain->SetBranchAddress("genKstTrkpMother", &genKstTrkpMother, &b_genKstTrkpMother);
   ...
   fChain->SetBranchAddress("rightFlavorTag", &rightFlavorTag, &b_rightFlavorTag);
...
Bool_t SingleBdToKstarMuMuSelector_xCheck2012::Notify()
{
...
#endif // #ifdef SingleBdToKstarMuMuSelector_xCheck2012_cxx
